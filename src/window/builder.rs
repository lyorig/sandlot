...
impl<'p, 'parent, 'parent_ctx, 'parent_vid> WindowBuilder<'p, 'parent, 'parent_ctx, 'parent_vid> {
    ...
    pub fn always_on_top(self, value: bool) -> Self {
    ...
    pub fn borderless(self, value: bool) -> Self {
    ...
    pub fn constrain_popup(self, value: bool) -> Self {
    ...
    pub fn ext_gfx_context(self, value: bool) -> Self {
        self.set_bool(
            SDL_PROP_WINDOW_CREATE_EXTERNAL_GRAPHICS_CONTEXT_BOOLEAN,
            value,
        )
    ...
    pub fn high_pixel_density(self, value: bool) -> Self {
    ...
    pub fn maximized(self, value: bool) -> Self {
    ...
    pub fn menu(self, value: bool) -> Self {
    ...
    pub fn metal(self, value: bool) -> Self {
    ...
    pub fn minimized(self, value: bool) -> Self {
    ...
    pub fn mouse_grabbed(self, value: bool) -> Self {
    ...
    pub fn opengl(self, value: bool) -> Self {
    ...
    pub fn parent(self, value: Ref<'parent, Window>) -> Self {
        _ = unsafe {
            self.inner
    ...
    pub fn utility(self, value: bool) -> Self {
    ...
    pub fn vulkan(self, value: bool) -> Self {
    ...
    pub fn position(self, pos: PointI32) -> Self {
        self.x(pos.x.into());
        self.y(pos.y.into())
    }
    ...
    pub fn build<'ctx, 'vid>(
        ...
        Window::from_raw(unsafe { SDL_CreateWindowWithProperties(self.inner.as_raw()) })
    }
    ...
    pub fn build_cleanup<'ctx, 'vid>(
        ...
        let res = Window::from_raw(unsafe { SDL_CreateWindowWithProperties(self.inner.as_raw()) });
