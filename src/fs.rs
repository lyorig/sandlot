...
//!
//! - Where is my app's data? [`ContextHandle::base_path`].
//! - Where can I safely write files? [`fs::pref_path`](pref_path).
//! - Where are paths like Downloads, Desktop, Music? [`ContextHandle::user_folder`].
...
//! - [x] SDL_GetBasePath (impl'd as [`ContextHandle::base_path`]
//! - [x] SDL_GetCurrentDirectory
//! - [x] SDL_GetPathInfo
//! - [x] SDL_GetPrefPath
//! - [x] SDL_GetUserFolder (impl'd as [`ContextHandle::user_folder`]
//! - [x] SDL_GlobDirectory
//! - [x] SDL_RemovePath
//! - [x] SDL_RenamePath
...
/// [`ContextHandle::base_path`] may not be writable.
